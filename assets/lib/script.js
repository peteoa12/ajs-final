	...
	var publicItem = {
		...
		options: {
			...
			rating: category.options && category.options.rating ? category.options.rating : {
				label: "Rating",
				type: "select",
				choices: ["1: Hated it", "2: Not worth the money", "3: OK, but nothing special", "4: Pretty Good. Glad I watched it.", "5: Awesome, life changing experience!"]
			},
...
var Cocktails = Drink({ //Objects used to call child class
	...
	options: { //Options represent the field to be used in our form
		type: { //Object keys will be used as the name for the field inputs
			...
			"Gin", "Vodka", "Rum", "Whiskey", "Wine"]
		},
		taste: {
			label: "Taste",
			type: "select",
			choices: ["Sweet", "Sour", "Bitter", "Bland", "Floral", "Fruity"]
		},
		again: {
...
var Movies = Video({ //Objects used to call child class
	...
	options: {
		...
		rating: {
			label: "Rating",
			type: "select",
			choices: ["1: Hated it", "2: Not worth the money", "3: OK, but nothing special", "4: Pretty Good. Glad I watched it.", "5: Awesome, Life changing, Amazingly Touching, or made by Pixar."]
		}
	}
});
